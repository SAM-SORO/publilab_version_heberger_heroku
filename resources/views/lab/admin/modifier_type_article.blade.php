...
<div class="container-sm mb-5 bg-white shadow-lg rounded-lg mt-5 py-5 px-5" style="max-width: 90%">
    ...
    <div class="border-bottom pb-4 mb-5">
        <div class="d-flex justify-content-between align-items-center">
            <a href="{{ route('admin.listeTypeArticle') }}" class="btn btn-outline-primary rounded-circle shadow-sm">
    ...
    <form action="{{ route('admin.updateTypeArticle', $typeArticle->idTypeArticle) }}" method="POST">
        @csrf
        @method('POST')
            ...
            <div class="card-body">
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="text" class="form-control form-control-lg @error('nomTypeArticle') is-invalid @enderror"
                           id="nomTypeArticle" name="nomTypeArticle"
                           value="{{ old('nomTypeArticle', $typeArticle->nomTypeArticle) }}" required>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('descTypeArticle') is-invalid @enderror"
                              id="descTypeArticle" name="descTypeArticle" rows="4">{{ old('descTypeArticle', $typeArticle->descTypeArticle) }}</textarea>
