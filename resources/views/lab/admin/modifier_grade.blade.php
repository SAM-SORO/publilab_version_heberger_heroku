...
<div class="container-sm mb-5 bg-white shadow-lg rounded-lg mt-5 py-5 px-5" style="max-width: 90%">
    ...
    <div class="border-bottom pb-4 mb-5">
        <div class="d-flex justify-content-between align-items-center">
            <a href="{{ route('admin.listeGrade') }}" class="btn btn-outline-primary rounded-circle shadow-sm">
    ...
    <form action="{{ route('admin.updateGrade', $grade->idGrade) }}" method="POST">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-header bg-dark text-white">
                <h5 class="mb-0"><i class="fas fa-info-circle"></i> Informations du grade</h5>
            </div>
            <div class="card-body">
                <!-- Sigle -->
                <div class="form-group mb-4">
                    ...
                    <input type="text" class="form-control form-control-lg @error('sigleGrade') is-invalid @enderror"
                           ...
                           value="{{ old('sigleGrade', $grade->sigleGrade) }}" required>
                    @error('sigleGrade')
