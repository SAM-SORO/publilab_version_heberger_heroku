        ...
        <div class="container-fluid d-flex align-items-center justify-content-center" id="login">
            ...
            <form action={{route("submitLogin")}} method="POST" id="form-login" class="shadow p-3 mb-5 bg-white rounded autocomplete-off col-12 col-sm-10 col-md-9 col-lg-4 mt-5 mt-sm-5 mt-md-5">
                ...
                <div class="form-group mb-4 mt-2">
                    ...
                    <input type="email" class="form-control @error('email_visit') is-invalid @enderror" id="email" name="email_visit" required autocomplete="email" autofocus value="{{old('email_visit')}}">
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="input-group">
                        <input type="password" class="form-control @error('password_visit') is-invalid @enderror" id="password" name="password_visit">
