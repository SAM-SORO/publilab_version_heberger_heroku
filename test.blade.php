                    ...
                    <div class="d-flex flex-column rounded shadow bg-white p-3 h-100">
                        <div class="d-flex">
                            <div class="ml-3">
                                ...
                                <!-- Ajout du nombre de doctorants -->
                                @if($theme->doctorants->count() > 0)
                                    <p>
                                        Doctorants associés : {{ $theme->doctorants->count() }}
                                        <button type="button" class="btn btn-link" data-toggle="modal" data-target="#doctorantsModal{{ $theme->idTheme }}">
                                            Voir la liste
                                        </button>
                                    </p>
                                @endif
...
<!-- Modal pour afficher les doctorants -->
<div class="modal fade" id="doctorantsModal{{ $theme->idTheme }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Doctorants travaillant sur ce thème</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
